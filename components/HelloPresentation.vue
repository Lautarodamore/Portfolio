<template>
  <div>
    <h3 data-aos="fade-right" class="saludo">Hi, my name is</h3>
    <h1 data-aos="fade-right" class="nombre-obj">Lautaro Damore.</h1>
    <h1
      data-aos="fade-right"
      class="nombre-obj"
      style="color: rgb(153, 159, 176);"
    >I create websites.</h1>
